...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Driver Assignment", href: "/admin/operations/driver-assignment", icon: <UserPlus className="h-4 w-4" />, permission: "driverAssignment" },
      { title: "AI Trip Planner", href: "/admin/operations/ai-trips", icon: <Calendar className="h-4 w-4" />, permission: "carpoolBookings" },
